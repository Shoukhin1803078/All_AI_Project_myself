...
def initialize_gemini():
    # api_key = get_api_key()
    api_key="AIzaSyBK-7B54slUUvwSfAFHiqv0MelBF1iKu9U"
...
prompt = st.chat_input("analysis the report and give me report result and based on report suggest me some medicine name")
